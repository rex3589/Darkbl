...
export default function HomePage({ userProfile }: { userProfile: UserProfile | null }) {
  ...
  const handleLoginClick = () => {
    if (userProfile?.isVip || userProfile?.role === 'admin') {
      // Access granted
      alert('Access Granted to DarkBlaiseX System');
    } else {
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-400 mb-10 text-sm uppercase tracking-[0.2em] font-bold">
            {userProfile?.isVip ? 'System Access Authorized' : 'Authorization Required'}
          </p>
          ...
          >
            ...
            <span className="relative z-10 text-xl">LOGIN</span>
          ...
          {!userProfile?.isVip && userProfile?.role !== 'admin' && (
            ...
            >
              ...
              <p>VIP Membership required for system access</p>
            </motion.div>
          )}
        </div>
      </motion.div>
